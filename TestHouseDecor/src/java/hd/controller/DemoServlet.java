...
import hd.JPA.OrdersJpaController;
import hd.JPA.PromotionJpaController;
...
//            PromotionJpaController promotionJpa = new PromotionJpaController(emf);
//            Promotion promotion = promotionJpa.findPromotion(1);
            //Send promotion
//            new Thread(new Runnable() {
//                @Override
//                public void run() {
//                    system.sendPromotionEmail(promotion);
//                }
//            }).start();
            //End send promotion

            
//            OrdersJpaController orderJpa = new OrdersJpaController(emf);
//            Orders order = orderJpa.findOrders(1);
            //Send order
//            new Thread(new Runnable() {
//                @Override
//                public void run() {
...
//            system.setNotificationProduct(request);

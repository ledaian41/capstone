 ...
 * @author cuk3t
 */
public class ShowListPhotoByCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Category category = cateJpa.findCategory(categoryId);
            PhotoDAO photoDao = new PhotoDAO();
            List<PhotoDTO> listDTO = photoDao.displayListPhotoByCategory(category.getCategoryName());

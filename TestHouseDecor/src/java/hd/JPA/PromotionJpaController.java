...
public class PromotionJpaController implements Serializable {
    ...
    public void create(Promotion promotion) {
        ...
        try {
            ...
            SellerInfo sellerInfoUserId = promotion.getSellerInfoUserId();
            if (sellerInfoUserId != null) {
                sellerInfoUserId = em.getReference(sellerInfoUserId.getClass(), sellerInfoUserId.getUserId());
                promotion.setSellerInfoUserId(sellerInfoUserId);
            }
            ...
            if (sellerInfoUserId != null) {
                sellerInfoUserId.getPromotionCollection().add(promotion);
                sellerInfoUserId = em.merge(sellerInfoUserId);
            }
    ...
    public void edit(Promotion promotion) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            SellerInfo sellerInfoUserIdOld = persistentPromotion.getSellerInfoUserId();
            SellerInfo sellerInfoUserIdNew = promotion.getSellerInfoUserId();
            ...
            if (sellerInfoUserIdNew != null) {
                sellerInfoUserIdNew = em.getReference(sellerInfoUserIdNew.getClass(), sellerInfoUserIdNew.getUserId());
                promotion.setSellerInfoUserId(sellerInfoUserIdNew);
            }
            ...
            if (sellerInfoUserIdOld != null && !sellerInfoUserIdOld.equals(sellerInfoUserIdNew)) {
                sellerInfoUserIdOld.getPromotionCollection().remove(promotion);
                sellerInfoUserIdOld = em.merge(sellerInfoUserIdOld);
            }
            if (sellerInfoUserIdNew != null && !sellerInfoUserIdNew.equals(sellerInfoUserIdOld)) {
                sellerInfoUserIdNew.getPromotionCollection().add(promotion);
                sellerInfoUserIdNew = em.merge(sellerInfoUserIdNew);
            }
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            SellerInfo sellerInfoUserId = promotion.getSellerInfoUserId();
            if (sellerInfoUserId != null) {
                sellerInfoUserId.getPromotionCollection().remove(promotion);
                sellerInfoUserId = em.merge(sellerInfoUserId);
            }
            em.remove(promotion);
            em.getTransaction().commit();

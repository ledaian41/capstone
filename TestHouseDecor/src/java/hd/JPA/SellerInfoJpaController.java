...
public class SellerInfoJpaController implements Serializable {
    ...
    public void create(SellerInfo sellerInfo) throws IllegalOrphanException, PreexistingEntityException, Exception {
        ...
        if (sellerInfo.getPromotionCollection() == null) {
            sellerInfo.setPromotionCollection(new ArrayList<Promotion>());
        }
        ...
        try {
            ...
            for (Promotion promotionCollectionPromotionToAttach : sellerInfo.getPromotionCollection()) {
                promotionCollectionPromotionToAttach = em.getReference(promotionCollectionPromotionToAttach.getClass(), promotionCollectionPromotionToAttach.getId());
                attachedPromotionCollection.add(promotionCollectionPromotionToAttach);
            }
            sellerInfo.setPromotionCollection(attachedPromotionCollection);
            ...
            for (Promotion promotionCollectionPromotion : sellerInfo.getPromotionCollection()) {
                SellerInfo oldSellerInfoUserIdOfPromotionCollectionPromotion = promotionCollectionPromotion.getSellerInfoUserId();
                promotionCollectionPromotion.setSellerInfoUserId(sellerInfo);
                promotionCollectionPromotion = em.merge(promotionCollectionPromotion);
                if (oldSellerInfoUserIdOfPromotionCollectionPromotion != null) {
                    oldSellerInfoUserIdOfPromotionCollectionPromotion.getPromotionCollection().remove(promotionCollectionPromotion);
                    oldSellerInfoUserIdOfPromotionCollectionPromotion = em.merge(oldSellerInfoUserIdOfPromotionCollectionPromotion);
                }
            }
    ...
    public void edit(SellerInfo sellerInfo) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Collection<Promotion> promotionCollectionOld = persistentSellerInfo.getPromotionCollection();
            Collection<Promotion> promotionCollectionNew = sellerInfo.getPromotionCollection();
            List<String> illegalOrphanMessages = null;
            ...
            for (Promotion promotionCollectionOldPromotion : promotionCollectionOld) {
                if (!promotionCollectionNew.contains(promotionCollectionOldPromotion)) {
                    ...
                    illegalOrphanMessages.add("You must retain Promotion " + promotionCollectionOldPromotion + " since its sellerInfoUserId field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            ...
            for (Promotion promotionCollectionNewPromotionToAttach : promotionCollectionNew) {
                promotionCollectionNewPromotionToAttach = em.getReference(promotionCollectionNewPromotionToAttach.getClass(), promotionCollectionNewPromotionToAttach.getId());
            ...
            sellerInfo.setPromotionCollection(promotionCollectionNew);
            ...
            for (Promotion promotionCollectionNewPromotion : promotionCollectionNew) {
                if (!promotionCollectionOld.contains(promotionCollectionNewPromotion)) {
                    SellerInfo oldSellerInfoUserIdOfPromotionCollectionNewPromotion = promotionCollectionNewPromotion.getSellerInfoUserId();
                    promotionCollectionNewPromotion.setSellerInfoUserId(sellerInfo);
                    promotionCollectionNewPromotion = em.merge(promotionCollectionNewPromotion);
                    if (oldSellerInfoUserIdOfPromotionCollectionNewPromotion != null && !oldSellerInfoUserIdOfPromotionCollectionNewPromotion.equals(sellerInfo)) {
                        oldSellerInfoUserIdOfPromotionCollectionNewPromotion.getPromotionCollection().remove(promotionCollectionNewPromotion);
                        oldSellerInfoUserIdOfPromotionCollectionNewPromotion = em.merge(oldSellerInfoUserIdOfPromotionCollectionNewPromotion);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            Collection<Promotion> promotionCollectionOrphanCheck = sellerInfo.getPromotionCollection();
            for (Promotion promotionCollectionOrphanCheckPromotion : promotionCollectionOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This SellerInfo (" + sellerInfo + ") cannot be destroyed since the Promotion " + promotionCollectionOrphanCheckPromotion + " in its promotionCollection field has a non-nullable sellerInfoUserId field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }

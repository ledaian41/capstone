            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="LoadAccountsServlet?status=0" class="waves-effect"><i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>Block List</a>
                        </li>
                    </ul>
                </div>
            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="MainAdminServlet" method="POST">
                                                            ...
                                                            <button class="btn btn-view" name="btnAction" value="ViewDetail">Detail</button>
                                                            <button class="btn btn-account" name="btnAction" value="BanAccount">Unban Account</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </c:forEach>

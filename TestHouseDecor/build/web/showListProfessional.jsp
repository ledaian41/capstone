                    ...
                    <div class="headerContainer" style="margin-bottom: 10px; border-bottom: 1px solid #e6e6e6;">                       
                        ...
                        <div class="whiteCard_pro-card " compid="uniprof" objid="james_crisp" posid="0">
                            <div class="pro-cover-photos">
                                <a href="ViewOverServlet?txtID=${dto.userId}" id="_h_url_paid_pro1" onmousedown="">
                            ...
                            <div class="vcard" itemscope="" itemtype="http://schema.org/LocalBusiness">
                                <div class="pro-header clearfix">
                                    ...
                                    <div class="name-info">
                                        <a href="ViewOverServlet?txtID=${dto.userId}" id="_h_url_paid_pro1" onmousedown="" class="pro-title" itemprop="name"><c:out value="${dto.professionalName}"/></a>

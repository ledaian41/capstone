                        ...
                        <div id="viewGallery1ColContent">
                            <div id="viewGalleryMainNarrow" itemscope="" itemtype="http://schema.org/Article">
                                <div class="view-gallery-header-row">
                                    <div class="clearfix">
					<a href="MyIdeaBooksServlet" class="colorLink back-to-ideabooks pull-left"><span class="hzi-font hzi-Left-Arrow"></span>&nbsp;Back to <c:out value="${user.firstname}"/> <c:out value="${user.lastname}"/>'s Ideabooks</a>
                                    </div>
...
<!--                                            <a class="hzBtnbutton_baseIcon" href="">
                            ...
                            <form method="POST" action="EditIdeaBookServlet">
                                ...
                                <div class="inlineEditDesc" style="margin-top: 10px">
                                    <textarea rows="3" class="form-control" value="" name="txtDes">${dto.description}</textarea>
                                </div>
                                    ...
                                    <form action="EditIdeaBookPhotoServlet" method="POST">
                                        ...
                                        <div class="image_ideaBook">  
                                            <div class="profile-pic-container" style="width:206px ">
                                                ...
                                                <textarea class="txtDescription form-control" id="txtDescription" rows="2" class="" value="" name="txtDescriptionPhoto">${IdeaBookPhotoRef.comment}</textarea>
                                            </div>                             
                                        </div>
                                    </form>

                                            ...
                                            <tbody>
                                                <c:forEach items="${sessionScope.LIST}" var="dto" varStatus="count">
                                                    <tr>
                                                        ...
                                                        <td class="txt-oflo">${dto.ideabook.userId.email}</td>
                                                        <td class="txt-oflo">${dto.ideabook.title}</td>
                                                        <td class="txt-oflo">${dto.category}</td>
                                                        <td class="txt-oflo">${dto.style}</td>
                                                        <td>
                                                            <form action="ManageIdeabookServlet" method="POST">
                                                                <input type="hidden" name="txtIdeabookId" value="${dto.ideabook.ideaBookId}" />

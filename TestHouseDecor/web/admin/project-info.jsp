                                ...
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <a href="MainAdminServlet?btnAction=viewdetail&txtUserId=${detail.professionalUserId.userId}">
                                                    <input type="text" class="form-control" readonly="true" value="${detail.professionalUserId.user.lastname} ${detail.professionalUserId.user.firstname}">
                                                </a>
                                                </input>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.professionalUserId.user.email}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Điện thoại</label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.professionalUserId.user.phoneNumber}">
                                            </div>
                                        </div>
                                        <div class="form-group">

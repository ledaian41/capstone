                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <h2>Quản lý sản phẩm 
                                        <c:if test="${sessionScope.LIST[0].product.status==0}">
                                            <small>Chờ duyệt</small>
                                        </c:if>
                                        <c:if test="${sessionScope.LIST[0].product.status==1}">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <c:forEach items="${sessionScope.LIST}" var="dto" varStatus="count">
                                                    <tr>
                                                        <td class="txt-oflo">
                                                            <img src="${dto.urlPhoto}" height="128dp" width="160dp" style="display: block" alt="image" />
                                                        </td>
                                                        <td class="txt-oflo">${dto.product.userId.taxNumber}</td>
                                                        <td class="txt-oflo">${dto.product.productName}</td>
                                                        <td class="txt-oflo">${dto.product.categoryCategoryId.categoryName}</td>
                                                        <td class="txt-oflo">${dto.product.styleStyleId.name}</td>
                                                        <td>
                                                            <form action="ManageProductServlet" method="POST">
                                                                <input type="hidden" name="txtProductId" value="${dto.product.productId}" />

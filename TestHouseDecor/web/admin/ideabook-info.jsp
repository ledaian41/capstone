                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.title}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Mô tả</label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <textarea class="form-control" readonly="true">${detail.description}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <c:if test="${detail.status==0}">
                                                <button form="ideabook" type="submit" class="btn btn-success" name="btnAction" value="accept">Hoàn Thành</button>
                                            </c:if>
                                    ...
                                    <form id="ideabook" action="ManageIdeabookServlet" method="POST">
                                        <input type="hidden" name="txtIdeabookId" value="${detail.ideaBookId}" />
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <form id="photo" action="ManageIdeabookServlet" method="POST">
                                                <input type="hidden" name="page" value="ideabook" />
                                                    ...
                                                    <div class="col-md-55">
                                                        <div class="thumbnail">
                                                            <div class="image view view-first">
                                                                <a href="ManageIdeabookServlet?btnAction=select&id=${dto.photoId}&form=0">

                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.userId.taxNumber}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.userId.sellerName}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Địa chỉ</label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <textarea class="form-control" readonly="true">${detail.userId.storeAddress}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Số điện thoại</label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <input type="text" class="form-control" readonly="true" value="${detail.userId.phone}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <form id="account" action="MainAdminServlet" method="POST">
                                        <input type="hidden" name="txtUserId" value="${detail.userId.userId}" />
                                    </form>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-55">
                                                    <div class="thumbnail">
                                                        <div class="image view view-first">
                                                            <img style="width: 100%; display: block;" src="${list.url}" alt="image" />
                                                        </div>

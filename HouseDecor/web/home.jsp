        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#portfolio">
                            <img style="height: 20px; width: 20px" src="assets/icon/alarm-clock-by-doubletwist-for-android.jpg" class="img-responsive " alt="" />
                        </a></li>
                            <li><a href="#about">
                         <img style="height: 20px; width: 20px" src="assets/icon/shopping-cart-of-checkered-design_318-50865.jpg" class="img-responsive " alt="" />
                        </a></li>
